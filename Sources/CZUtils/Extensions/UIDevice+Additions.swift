...
@objc
extension UIDevice {
  /// Returns the device type of the current device. e.g. "iPhone 13 Pro Max".
  @objc
  public static var type: String {
    ...
    return deviceType(with: deviceCode)
  }
  ...
  private static func deviceType(with deviceCode: String) -> String {
    ...
    case "i386", "x86_64", "arm64":
      ...
      return "Simulator \(deviceType(with: identifier))"
    default: return deviceCode
    }
  }
}
